* Для запуску в режимі апплету, запустіть "**Альбоми**" кнопкою {% include /inc/btn.txt btn="A" %}, утримуючи клавішу {% include /inc/btn.txt btn="R" %}, до тих пір, поки меню не запуститься
