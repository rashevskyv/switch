...
**Кефир** - **не прошивка**! Это сборник, состоящий из прошивки (Atmosphere или SX OS на выбор) и необходимого минимума рекомендуемых программ, плагинов, модулей и другого софта. Подробнее о составе кефира ниже
...
Если вы пользователь MacOS, воспользуйтесь [этой инструкцией](https://gbatemp.net/threads/sdcard-cleanup-script-for-for-macos-users.521177/){:target="_blank"} (англ.), чтобы избежать проблем с картой памяти
{: .notice--warning}
