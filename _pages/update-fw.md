...
Нажмите кнопку (POWER), чтобы запустить прошивку и [обновите](update-fw){:target="_blank"} {% include abbr/emunand.md abbr="EmuNAND" %} до актуальной версии системного ПО
