...
* Встановлений свіжий {% include abbr/kefir_addr.txt %}
...
1. Встановіть {% include abbr/kefir_addr.txt %} за інструкцією, що знаходиться в його репозиторії
...
Цей спосіб працює тільки на приставках першої ревізії - {% include abbr/erista.md %}
{: .notice--warning}
