...
1. [Обновление EmuNAND до актуальной версии системного ПО](update-fw){:target="_blank"} - теперь запускаем кастом. Он автоматически запустится из созданного ранее {% include abbr/ua/emunand.md abbr="EmuNAND" %}. Нам потребуется обновить его на актуальную версию системного ПО, при этом оставив {% include abbr/ua/sysnand.md abbr="SysNAND" %} в его первозданном виде, без следов запуска кастомной прошивки
