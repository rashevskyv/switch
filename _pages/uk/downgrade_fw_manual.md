...
1. Удерживайте кнопку {% include inc/btn.txt btn="POWER" %} 15 секунд, пока не погаснет подсветка экрана Switch
...
1. Выключите Switch, зажав кнопку {% include inc/btn.txt btn="POWER" %} на 15 секунд, пока подсветка экрана не отключится
