...
1. Перейдите в нужный раздел, выберите игру и нажмите {% include inc/btn.txt btn="A" %}
	* В разделе **Новые игры** находятся все игры, которые есть на сервере
		* Для поиска нажмите {% include inc/btn.txt btn="+" %} на джойконе, находясь на строке **Новые игры** в левой части меню
...
1. Нажмите {% include inc/btn.txt btn="B" %}, чтобы свернуть появившееся окно
...
1. После того, как выбранная игра скачается, выйдите из программы кнопкой {% include inc/btn.txt btn="HOME" %}
