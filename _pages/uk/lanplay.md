...
1. Выберите ваше текущее подключение, нажмите на нём {% include inc/btn.txt btn="A" %} и выберите "**Изменить настройки**"
...
1. Запустите игру
1. Нажмите одновременно {% include inc/btn.txt btn="L" %}+{% include inc/btn.txt btn="R" %}+(Left_Analog)
