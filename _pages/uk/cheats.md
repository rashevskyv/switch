...
1. Запустите приложение **Kefir Updater** через [hbl](/uk/hbl){:target="_blank"}
...
1. Нажмите {% include inc/uk/btn.txt btn="+" %} чтобы закрыть программу
1. Вернитесь в главное меню

## Работа с читами

1. Запустите игру, для которой хотите применить чит
1. Одновременно нажмите {% include inc/uk/btn.txt btn="L" %}+{% include inc/uk/btn.txt btn="ВНИЗ" %}+{% include inc/uk/btn.txt btn="R3" %}, чтобы открыть **Tesla**-меню 
...
1. Закройте Tesla кнопкой {% include inc/uk/btn.txt btn="B" %}
