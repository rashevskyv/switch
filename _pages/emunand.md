...
Я рекомендую использовать Semi-Stock для запуска стока. Это дает ряд преимуществ, например, позволит перезагружать консоли первой ревизии без проброса пейлоада, а так же избавит от ряда проблем при обновлении официальной прошивки через настройки. 
{: .notice--warning}
