...
1. Загрузитесь в Stock и отключите в настройках приставки облачные сохранения (настройки -> управление данными -> облачное хранилище -> настройки)
    * Если вы пропустили этот пункт, делайте "**Unlink all accounts**" с помощью [Linkalho](link-account){:target="_blank"}, перезагрузите приставку, затем сделайте "**Link all accounts**" и снова перезагрузите приставку, иначе вы будете видеть ошибку при каждом запуске игры
