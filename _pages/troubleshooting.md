...
**О:** Перезагрузите приставку. Если это не помогло, исправьте атрибуты (не работает на не прошивайках!)
...
**О:** Установите её повторно. При установке все мусорные файлы автоматически будут очищены. Если таковой возможности нет, удалите содержимое папки `/Nintendo/content/placehld`
{% endspoiler %}
...
* Удалите tinfoil, обновите кефир, установите tinfoil из папки games на карте памяти 
...
**О:** Даже слегка измененный сейв любой игры (измененный читами, редактором сохранений, хекс-редактором или другими инструментами) опасно переносить на не прошитую приставку. Более того, сейвы некоторых игр знают, что они были сделаны не на той консоли, на которой они сейчас работают. 
