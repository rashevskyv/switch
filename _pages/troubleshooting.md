...
Сделайте "**Unlink all accounts**" с помощью [Linkalho](link-account){:target="_blank"}, перезагрузите приставку, затем пробуйте удалить пользователя. Не забудьте потом прилинковать оставшиеся аккаунты.
