...
1. Встановіть свіжу версію {% include abbr/kefir_addr.txt %}, якщо ще не робили цього.
...
В цей момент, після виконання інструкції вище, ви вже знаходиться в кастомній прошивці. Якщо вам потрібно потрапити в {% include abbr/hekate.txt abbr="hekate" %}, перезавантажте приставку через меню живлення і затисніть кнопку зниження гучності на сплешскріні кефіру.
{: .notice--info}
