...
* Установленная на донгле {% include abbr/ru/hekate.txt abbr="hekate" %}
	* Инструкция для [R4S](/ru/r4#прошивка-донгла){:target="_blank"}
	* Инструкция для [RCMLoader](/ru/rcmloader#прошивка-донгла){:target="_blank"}
...
# Следующий шаг: [Подготовительные работы](/ru/preparation-fuse)
{: .notice--success}
