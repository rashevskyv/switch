...
<!-- Fusée Gelée -->
1. Запустите [{% include abbr/ru/cfw.txt abbr="кастом" %}](cfw){:target="_blank"}
...
Нажмите кнопку (POWER), чтобы запустить прошивку и [обновите](update-fw){:target="_blank"} {% include abbr/ru/emunand.md abbr="EmuNAND" %} до актуальной версии системного ПО
