...
1. Распакуйте содержимое папки [caffeine.zip](/ru/files/caffeine.zip){:target="_blank"} в корень карты памяти с установленным кефиром с заменой (**объединить** на macOS)
