...
Если вы используете [Caffeine](/ru/caffeine){:target="_blank"}, то вам **ни в коем случае** нельзя использовать AutoRCM! Иначе приставка превратится в кирпич! При любых подозрениях на включенный AutoRCM, удалите его по этой инструкции!
{: .notice--danger}
...
1. [Запустите](/ru/cfw){:target="_blank"} {% include abbr/ru/cfw.txt abbr="кастомную прошивку" %}
