...
header:	
  ...
  overlay_filter: 0.5
  caption:
excerpt: 'Полное руководство по прошивке Nintendo Switch<br />**Последнее изменение:** 15 января'
---
...
{% spoiler Чип (модчип, SX Core, Sx Lite, RCMX86) %}
