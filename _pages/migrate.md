...
{% spoiler Часть I - Подготовительные работы %}
...
{% spoiler Часть II - Запуск прошивки %}
...
{% spoiler Если EmuNAND есть %}

{% spoiler Часть III - Перенос EmuNAND с SX OS в Atmosphere %}
...
{% spoiler Если EmuNAND отсутствует %}

{% spoiler Часть III - Создание EmuNAND через hekate %}
...
1. Нажмите "**Create emuMMC**" -> "**SD File**"
	...
	* После того, как эмунанд создан и работает, вы можете его уменьшить, следуя [этой инструкции](emunand#уменьшение-emunand-в-программе-nxnandmanager){:target="_blank"}
...
{% spoiler Часть IV - Бекап прошивки и ключей %}
