...
1. [Скачайте прошивку](https://darthsternie.net/switch-firmwares/){:target="_blank"}, соответствующую текущей версии прошивки вашего emunand
	* Важно точно знать какая прошивка на вашем emunand! Попробуйте запустить SXOS и посмотреть какая версия прошивки в вашем EmuNAND. Для этого скачайте {% include vars/sxos.txt %} и поместите скачанный `boot.dat` в корень карты памяти с заменой, затем вставьте КП в консоль и включите приставку 
