...
Если вы не знаете есть ли у вас {% include abbr/emunand.txt abbr="EmuNAND" %}, вставьте карту памяти в ПК и посмотрите есть ли в папке `sxos` папка `emunand`. Если пака есть - у вас есть эмунанд 
{: .notice--info}
