...
1. Воспользуйтесь инструкцией для установки чипа в приставку для [полноразмерного Switch](https://www.sthetix.info/installing-the-sx-core-mod-kit-full-guide/){:target="_blank"} или [Switch Lite](https://www.sthetix.info/installing-the-sx-lite-mod-kit/){:target="_blank"}.
