...
* Встановіть {% include abbr/uk/kefir_addr.txt %}, якщо ще не робили цього
...
1. У вікні, що відкрилося, наберіть:
	...
	* Якщо у вас {% include abbr/uk/mariko.md %}, то додайте ключ `--mariko` після версії прошивки (наприклад, `EmmcHaccGen --keys prod.keys --fw 14.1.0 --mariko`)
