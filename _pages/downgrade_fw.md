...
* [SystemRestoreV3.te](https://suchmememanyskill.github.io/TegraScript/scripts/SystemRestoreV3.te){:target="_blank"} - скрипт для восстановления прошивки
...
1. На карте памяти приставки создайте папку `FW` и поместите туда [SystemRestoreV3.te](https://suchmememanyskill.github.io/TegraScript/scripts/SystemRestoreV3.te){:target="_blank"}, а так же `boot.bis` и папку `SYSTEM`, которые находятся в папке `NX-X.X.X-exfat`
...
1. Следуйте информации на экране и восстановите BIS и SYSTEM 
