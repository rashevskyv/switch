...
* **Не використовуйте Tinfoil.** Публічних магазинів немає, програма для типової установки ігор не працює. Ставте NSP/XCI через **DBI** (нижче). Архів: [сторінка Tinfoil](/tinfoil). 
