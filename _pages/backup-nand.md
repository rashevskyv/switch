...
* Работающая microSD, с не менее чем 32 Гб свободного места, в формате FAT32
...
Этот способ работает только на приставках первой ревизии - {% include abbr/erista.md %}
{: .notice--warning}
